...
<body>
	...
	<div class="container-xxl">
		<div class="authentication-wrapper authentication-basic container-p-y">
			<div class="authentication-inner">
				...
				<div class="card">
					<div class="card-body">
						<h4 class="mb-2">Welcome to barenbliss 💖</h4>
						...
						<form class="mb-3" action="<?= base_url('auth/login')?>" method="POST">
							...
							<div class="text-center mt-3">
								<p>
									Kalau belum punya akun, <a href="<?= base_url('auth/register'); ?>">registrasi
										dulu</a>.
								</p>
							</div>
	...
	<script src="<?= site_url('assets')?>/assets/vendor/libs/jquery/jquery.js"></script>
	...
	<!-- Vendors JS -->
	<!-- Main JS -->
	<script src="<?= site_url('assets')?>/assets/js/main.js"></script>
	<!-- Page JS -->
