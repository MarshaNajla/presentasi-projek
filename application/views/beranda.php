...
<body class="blog-page">
	...
	<main class="main">
		<!-- Page Title -->
		<div class="page-title dark-background" style="margin: 0; padding: 0;">
			<!-- Menghapus margin dan padding -->
			<div class="container-fluid position-relative" style="padding: 0; margin-top: 70px;">
				<!-- Menambahkan margin-top untuk menurunkan carousel -->
