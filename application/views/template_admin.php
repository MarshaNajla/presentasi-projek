...
>
 ...
 <!-- mencetak dashboard ke dalam halaman nya -->
      ...
      <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand demo">
            <a href="<?= base_url();?>" class="app-brand-link">
              ...
              <span class="app-brand-text demo menu-text fw-bolder ms-2">BARENNBLIS</span>
            </a>
            ...
            <?php if($this->session->userdata('level')=='Admin') {?>
              <li class="menu-item <?php if($menu=='user'){ echo "active"; }?>">
                <a href="<?= site_url('admin/user')?>" class="menu-link">
                  ...
                  <div data-i18n="Tables">User (๑˃ᴗ˂)ﻭ</div>
                </a>
              </li>
        ...
        <div class="layout-page">
              ...
              <ul class="navbar-nav flex-row align-items-center ms-auto">
                ...
                <li class="nav-item navbar-dropdown dropdown-user dropdown">
                  ...
                  <ul class="dropdown-menu dropdown-menu-end">
                    ...
                    <li>
                      <a class="dropdown-item" href="<?= site_url('admin/user') ?>">
          ...
          <div class="content-wrapper">
            ...
            <!-- memanggil konten yg di dashboard -->
             <?= $contents; ?>
            </div>
            <!-- / Content -->
            ...
            <footer class="content-footer footer bg-footer-theme">
              <div class="container-xxl d-flex flex-wrap justify-content-between py-2 flex-md-row flex-column">
                <div class="mb-2 mb-md-0">
                  ...
                  , made with 🎀  🌸 by
                  <a href="https://themeselection.com" target="_blank" class="footer-link fw-bolder">marshaaa najlaa sorayaa</a>
                </div>
